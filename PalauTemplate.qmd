...
HC_donut_plot <- plot_donut(1705, year = 2014, depth = "shallow", cover_type = "hard coral")

MA_donut_plot <- plot_donut(1705, year = 2014, depth = "shallow", cover_type = "macroalgae")
...
HC_donut_plot2 <- plot_donut(1705, year = 2014, depth = "deep", cover_type = "hard coral")

MA_donut_plot2 <- plot_donut(1705, year = 2014, depth = "deep", cover_type = "macroalgae")

HC_donut_plot2 + MA_donut_plot2 + patchwork::plot_layout(ncol = 1) + patchwork::plot_annotation(tag_levels = "a")
```
...
HC_cover_plot <- plot_site_cover(1705, year = 2014, cover_type = "hard coral", depth = "shallow")
...
MA_cover_plot <- plot_site_cover(1705, year = 2014, cover_type = "macroalgae", depth = "shallow")
...
site_composition1 <- plot_site_composition(1705, year = 2014, depth = "shallow")
